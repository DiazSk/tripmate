 ...
 *
 * Has to agree with `BudgetBar`, which shows the same sum — two surfaces disagreeing about
 * whether you are over budget is exactly the drift the contract docblock in itinerary.ts was
 * written about.
 */
