  ...
  return (
    <main className="pointer-events-auto mx-auto max-w-3xl scheme-light bg-white p-8 pt-10 text-black sm:pt-12 print:pt-0">
      ...
      <section className="break-before-page pt-6">
        ...
        <p className="mt-2 max-w-[58ch] text-neutral-700">
        ...
        <ol className="mt-4 max-w-[58ch] list-decimal space-y-2 pl-6 text-neutral-800">
          {REVIEW_QUESTIONS.map((q) => (
            <li key={q}>{q}</li>
          ))}
        </ol>
        <p className="mt-6 max-w-[58ch] text-sm text-neutral-600">
