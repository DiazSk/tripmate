      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            // sibling of `.app-shell`, so neither the print block nor Story mode's chrome hiding
            // can reach it from inside. The class is the hook both use.
            //
            ...
            className="llm-trace-fab glass-control fixed right-5 bottom-5 z-50 hidden h-12 w-12 items-center justify-center rounded-full text-foreground transition-transform hover:scale-105 sm:flex print:hidden"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="llm-trace-fab fixed right-5 bottom-5 z-50 flex h-[min(32rem,calc(100dvh-6rem))] w-[min(23rem,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-2xl border border-card-border bg-surface-deep shadow-2xl"
          >
